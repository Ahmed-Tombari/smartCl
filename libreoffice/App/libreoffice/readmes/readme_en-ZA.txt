...
The RPMS (or DEBS, respectively) directory also contains a package named libreoffice5.2-freedesktop-menus-5.2.0.1-1.noarch.rpm (or libreoffice5.2-debian-menus_5.2.0.1-1_all.deb, respectively, or similar). This is a package for all Linux distributions that support the Freedesktop.org specifications/recommendations (http://en.wikipedia.org/wiki/Freedesktop.org), and is provided for installation on other Linux distributions not covered in the aforementioned instructions.
