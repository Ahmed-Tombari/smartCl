...
======================================================================
ReadMe do LibreOffice 5.2
======================================================================


Para vefr as últimas alterações a este ficheiro, consulte http://www.libreoffice.org/welcome/readme.html.
...
A comunidade LibreOffice é responsável pelo seu desenvolvimento e incentiva todos os utilizadores a integrar a comunidade. Se é um novo utilizador, pode visitar a página do LibreOffice, na qual encontra informações sobre o projeto e sobre as comunidades do LibreOffice. Consulte http://www.libreoffice.org/.
...
Se você aprecia o trabalho dos colaboradores, certifique-se que o LibreOffice continua assim no futuro e pondere a hipótese de ajudar no projeto - veja http://www.documentfoundation.org/contribution/ e saiba mais detalhes. Todas as pessoas podem participar de alguma forma.
...
Clique no botão direito do rato no diretório e escolha "Abrir no terminal". Um janela de terminal irá abrir. A partir da linha de comandos da janela do terminal, insira o seguinte comando (a sua palavra-passe de utilizador "root" irá ser-lhe perguntada antes do comando ser executado):
...
Para sistemas baseados em Fedora: su -c yum install *.rpm
...
O diretório de RPMS (OU DEBS) também contém um pacote com o nome libreoffice5.2-freedesktop-menus-5.2.0.1-1.noarch.rpm (ou libreoffice5.2-debian-menus_5.2.0.1-1_all.deb, respetivamente, ou similar). Este é o pacote a utilizar para todas as distribuições Linux que cumpram as especificações/recomendações Freedesktop.org (http://en.wikipedia.org/wiki/Freedesktop.org) e é disponibilizado para a instalação em outras distribuições Linux que não estejam abrangidas pelas instruções acima mencionadas.
...
Normalmente, as dificuldades em iniciar o LibreOffice (por exemplo, bloqueio das aplicações) bem como os problemas na exibição são originados pelo controlador da placa gráfica. Se estes problemas ocorrerem, atualize o controlador da placa gráfica ou tente utilizar o controlador fornecido com o sistema operativo. As dificuldades com objetos 3D são normalmente resolvidas através da desativação da opção "Utilizar OpenGL" em "Ferramentas - Opções - LibreOffice - Ver - Vista 3D".
...
----------------------------------------------------------------------
Problemas ao enviar documentos por e-mail a partir do LibreOffice
----------------------------------------------------------------------

Ao enviar um documento através de "Ficheiro - Enviar - Documento por e-mail" ou "Documento como PDF anexo" podem ocorrer problemas (falha ou bloqueio do programa). Isto deve-se ao sistema de ficheiros do Windows "Mapi" (Messaging Application Programming Interface) que causa problemas em algumas versões de ficheiros. Infelizmente, não foi possível restringir o problema a uma versão específica. Para mais informações, consulte http://www.microsoft.com e pesquise na base de conhecimento da Microsoft por "mapi.dll".

----------------------------------------------------------------------
Notas importantes de acessibilidade
----------------------------------------------------------------------

Para mais informações sobre as funções de acessibilidade do LibreOffice, consulte a página http://www.libreoffice.org/accessibility/

----------------------------------------------------------------------
Suporte técnico
----------------------------------------------------------------------

A página de suporte http://www.libreoffice.org/support/ disponibiliza diversas formas de ajuda para o LibreOffice. A sua dúvida pode até já ter sido respondida - verifique o fórum da comunidade em http://www.documentfoundation.org/nabble/ ou procure nos arquivos da lista de correio "users@libreoffice.org" em http://www.libreoffice.org/lists/users/. Em alternativa, pode enviar as suas dúvidas para users@libreoffice.org. Se pretender subscrever a lista, envie uma mensagem sem texto para: users+subscribe@libreoffice.org.

Veja também as FAQ na página http://www.libreoffice.org/faq/.

----------------------------------------------------------------------
Comunicar erros & problemas
----------------------------------------------------------------------

O nosso sistema de reporte, acompanhamento e solução de erros é o BugZilla e está alojado em https://bugs.libreoffice.org/. Encorajamos todos os utilizadores a reportarem os erros que possam encontrar. O reporte de erros é a contribuição mais importante que os utilizadores podem dar, pois só assim é que a comunidade pode continuar a desenvolver e melhorar o LibreOffice.
...
Enquanto utilizador, você já é uma parte importante do processo de desenvolvimento. No entanto, gostaríamos de o incentivar a ter um papel mais ativo, oferecendo o seu contributo na comunidade. Veja como pode contribuir na página http://www.libreoffice.org/contribution/

Como começar
----------------------------------------------------------------------

A melhor forma de participar é subscrevendo as listas de correio, verificar o método de trabalho e utilizar os arquivos de mensagens para se acostumar aos diversos tópicos abrangidos, desde que o código fonte do LibreOffice foi disponibilizado, em outubro de 2000. Quando se sentir à vontade, só precisa de enviar uma mensagem para a lista de correio, apresentar-se e começar a interagir com os membros. Se souber como funcionam os projetos de código livre, verifique as listas de elementos a desenvolver (TODO) e verifique se existe algo em que acha que pode participar na página http://www.libreoffice.org/develop/.

Subscrever
----------------------------------------------------------------------

As listas de correio que o utilizador pode subscrever estão disponíveis em http://www.libreoffice.org/contribution/
...
Esperamos que o novo LibreOffice 5.2 corresponda às suas expectativas e aguardamos a sua integração na equipa.
